...
public class Subscriber implements Serializable, SubscriberAndServices {
  ...
  /*  public double showCurrentSubscriberTime() {
        ...
        long difference = date3.getTime() - date2.getTime();
        long currentDays = difference / (24 * 60 * 60 * 1000);
        System.out.println("Осталось количество дней до окончания услуг:" + currentDays);
